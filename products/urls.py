...
from products.views import add_product, delete_basket, basket_update, product_discount_expiration, follow_product_availability
...
urlpatterns = [
    ...
    path('follow/<int:product_id>/', follow_product_availability, name='follow'),
